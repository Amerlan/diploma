...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">@lang('messages.my_processes')</li>
        </ol>
    </nav>

    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">@lang('messages.my_processes')</h1>
    </div>
        ...
        <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
            ...
            @foreach($processes as $process)
                <tr>
                    ...
                    <td>
                        <a href={{ route('my_process_details',['id' => $process ->process_id] )}} class="btn btn-primary btn-sm">@lang('messages.more_details')</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
