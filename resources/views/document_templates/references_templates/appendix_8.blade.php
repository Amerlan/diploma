    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Справка - Приложение 8</li>
            </ol>
        </nav>

        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Справка - Приложение 8</h1>
                        ...
                        <div class="card-text">
                            ...
                            <div class="row mt-5">
                                <div class="col-8 offset-2">
                                    ...
                                    @else
                                        &nbsp;&nbsp;&nbsp;Дана  гражданину  Муталов Дамир Абдуганиевич 12.07.2001г.р.<br><br>
                                        &nbsp;&nbsp;&nbsp;В том, что он(а) действительно является обучающимся <br>
                                        АО Международного университета информационных технологий «B057» - Информационные технологии в IT.<br>
                                        Госуд.лицензия Серия АБ  № 0064060 от 29.05.2009 год без ограничения срока,<br>
                                        2 курса, форма обучения-дневное.<br>
                                        Справка действительна на {{date('Y')}} - {{date('Y', strtotime('+1 year'))}} учебный год.<br>
                                        Справка выдана для предъявления в отделение<br>
                                        Государственной корпораций<br>
                                        Срок обучения в учебном заведении  4 (четыре) года<br>
                                        Период обучения с 01.09.2019г  г по 30.06.2020г.<br><br>
