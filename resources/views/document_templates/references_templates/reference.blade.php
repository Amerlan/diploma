    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Справка по месту требования</li>
            </ol>
        </nav>

        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Справка по месту требования</h1>
                            ...
                            <div class="row mt-5">
                                <div class="col-8 offset-2">
                                    @if($users != null)
                                        ...
                                        Период обучения с {{$users[1]->enrollment_date}} по {{$users[1]->graduation_date}}
                                    @else
